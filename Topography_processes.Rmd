...
__options for smoothing river:__
...
knitr::opts_knit$set(root.dir=UserWD,errot=T)
...
```
##Check if all the libraries have been installed. If not, install first and library them.
```{r}
...
```{r, calculate the slope and drainage area}
setwd(FolderName)
