...
#StreamTraverse - Function to process stream networks walking upstream on d4 neigbors
...
if(missing(basins)){basins=matrix(1,nrow=nx, ncol=ny)} #make all the basins=1
